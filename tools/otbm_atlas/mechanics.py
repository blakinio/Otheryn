...
def index_scripts(scripts_root: Path) -> dict[str, object]:
	...
	# Dynamic table/index dispatch is intentionally not promoted to factual UID evidence.
	# It remains UNKNOWN unless the concrete UID is registered literally in source.
