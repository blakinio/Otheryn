...
class AssetTests(unittest.TestCase):
	...
	def test_appearance_wire_decoder_reads_ground_and_sprite_info(self) -> None:
		...
		# Exercise the file API with no generated protobuf dependency.
		import tempfile
	...
	def test_extract_sprite_uses_catalog_layout_grid(self) -> None:
		...
		# Sprite 11 is the second 32x32 cell when first id is 10.
		for y in range(32):
