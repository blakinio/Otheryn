...
function installCreatureAnimation(){
  ...
  const ctx=overlay.getContext('2d'),images=new BoundedLRU(256,64*1024*1024),shards=new BoundedLRU(64,8*1024*1024),descriptors=new BoundedLRU(128,4*1024*1024),pendingShards=new Set,pendingDescriptors=new Set;
