...
first_failure:
  marker: none
  evidence: No concrete spawns-owned target defect was isolated; prior failures were proof-harness sizing or stale CI merge-ref issues and were repaired outside target production/data scope.
rejected_hypotheses:
