...
No runtime, production, database, protocol, asset, upstream, or deployment mutation is authorized.
...
derived:
  - A normative autonomous-program loop can remove premature task-by-task returns while preserving repository-specific Git and safety rules.
unknown:
