...
This root bootstrap is automatically loaded by Codex. It supplements and never weakens system, developer, owner, repository-allowlist, safety, production, credential, asset, deployment, merge, or cross-repository restrictions.
